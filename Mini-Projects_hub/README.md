...
## Section 05 · Exceptions (v3 refactors)

### 1) Robust Unit Converter — v3 (error handling)

**Goal:** Add comprehensive error handling to make the converter bulletproof.

**Core Features**

- Handle invalid menu choices gracefully
- Validate numeric input with helpful error messages
- Handle file operations safely (if saving conversion history)
- Continue operation after errors instead of crashing

**Concepts Reinforced**

- try/except for user input validation
- Multiple exception types (ValueError, TypeError)
- Graceful error recovery in loops
- User-friendly error messages

**Suggested Steps**

1. Wrap input conversion in try/except
2. Add validation for menu choices
3. Handle edge cases (empty input, special characters)
4. Add optional conversion history with file error handling

**Edge Cases / Pitfalls**

- Non-numeric input for conversions
- Out-of-range menu selections
- File permission errors (if adding history feature)
- Recovery after multiple consecutive errors
...
- [ ] Handles file operations safely (if implemented)

**Metadata**

- File: `unit_converter_v3.py`
- Difficulty: ★★★

---

### 2) Bulletproof Calculator — v3 (comprehensive error handling)

**Goal:** Make the calculator handle all possible errors gracefully.

**Core Features**

- Robust input validation for numbers and operations
- Safe division with clear zero-division messages
- Handle invalid operation choices
- Memory of previous results with error recovery

**Concepts Reinforced**

- Input validation with try/except
- Custom error messages
- Exception handling in mathematical operations
- Graceful degradation

**Acceptance Checklist**

- [ ] Handles non-numeric input gracefully
- [ ] Clear division-by-zero messages
- [ ] Invalid operation choices handled
